...
<?php   
   ...
   echo "<h3>\n Base de datos: </h3>";
    ...
    $conexion_info = mysqli_connect("127.0.0.1",'root','','information_schema');  /* conexion a BD  */
   ...
   if($rawdata_inf[$i_inf][0]===$base){echo " selected>";}else{echo "><h4>";}
    ...
    $conexion_info = mysqli_connect("127.0.0.1",'root','','information_schema'); 
   ...
   if($rawdata_inf[$i_inf][0]===$tabla){echo " selected>";}else{echo ">";}
    ...
    echo "<h3>\n \n Formulario Dinamico de ".$tabla."</h3>";
...
////semamo el profe
   ...
   for($i=0;$i<$filas;$i++){
       ...
       echo "' name='campo_".$rawdata[$i][0]."' value='' required maxlength = '";
